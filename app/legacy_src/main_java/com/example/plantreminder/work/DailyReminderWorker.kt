...
import com.example.plantreminder.PlantReminderApplication
...
class DailyReminderWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return runCatching {
            container.generatePendingCareUseCase(source = com.example.plantreminder.domain.models.MessageSource.WORKER)
